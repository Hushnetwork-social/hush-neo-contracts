...
namespace Neo.SmartContract.Template
{
    ...
    public class TokenTemplate : Neo.SmartContract.Framework.Nep17Token
    {
        ...
        private static bool IsBuggyV2TransferBlocked(UInt160 from) => from != null;
        ...
        {
            if (IsBuggyV2TransferBlocked(from))
                throw new InvalidOperationException("BUGGY V2: token transfers disabled");
