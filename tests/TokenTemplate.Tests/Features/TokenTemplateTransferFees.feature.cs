...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/TokenTemplateTransferFees.feature.ndjson", 23);
        }
...
#line hidden
#line 44
    await testRunner.AndAsync("walletA\'s GAS balance increased by 500000 datoshi from the transfer", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
#line 102
    await testRunner.AndAsync("walletA\'s GAS balance increased by 0 datoshi from the transfer", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
